...
# Parse the arguments
# eg. python3 phylo.py (input distance matrix file) (input fasta file) (output pdf file)
import sys  # argv
args = sys.argv
...
# Remove clade names with 'Inter#' (see https://vigne-cla.com/16-1/)
...
#See https://stackoverflow.com/questions/33147651/biopython-phylogenetic-tree-edit-labels-in-svg-file
